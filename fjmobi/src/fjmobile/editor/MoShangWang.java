...
public class MoShangWang extends EditorPart {
	...
	public static final String ID = "fjmobile.editor.MoShangWang"; //$NON-NLS-1$
	...
	public void createPartControl(Composite parent) {
		...
		button_2.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(final SelectionEvent e) {
				if (!DBFactory.clearAll("moshangwang")) {
		...
		actionList.add("moshangwang_retain");
	...
	private void setTime(Label l) {
		...
		DBFactory.Sysprop("moshangwang_time", time);
		l.setText(time);
	}
