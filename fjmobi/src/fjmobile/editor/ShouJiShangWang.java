...
public class ShouJiShangWang extends EditorPart {
	...
	public static final String ID = "fjmobile.editor.ShouJiShangWang"; //$NON-NLS-1$
	...
	public void createPartControl(Composite parent) {
		...
		button_5.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(final SelectionEvent e) {
				...
				e.display.syncExec(new Runnable() {
					public void run() {
						getMobiles();
						refresh("shoujishangwang", "cancel");
					}
				});
				setTime(label_1);
			}
		...
		button_2.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(final SelectionEvent e) {
				if (!DBFactory.clearAll("shoujishangwang")) {
		...
		actionList.add("shoujishangwang_retain");
	...
	private void setTime(Label l) {
		...
		DBFactory.Sysprop("shoujishangwang_time", time);
		l.setText(time);
	}
