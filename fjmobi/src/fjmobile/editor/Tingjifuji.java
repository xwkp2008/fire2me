...
public class Tingjifuji extends EditorPart {
	...
	public static final String ID = "fjmobile.editor.Tingjifuji"; //$NON-NLS-1$
	...
	public void createPartControl(Composite parent) {
		...
		newColumnTableColumn.setText("状态");
		...
		String time = DBFactory.getProp("tingjifuji_time");
		...
		actionList.add("fuji_retain");
		actionList.add("tingji_retain");
		actionList.add("istingji_retain");
	...
	private void setTime(Label l) {
		...
		DBFactory.Sysprop("tingjifuji_time", time);
		l.setText(time);
	}
