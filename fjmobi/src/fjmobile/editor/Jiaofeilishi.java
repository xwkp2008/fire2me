...
public class Jiaofeilishi extends EditorPart {
	...
	public static final String ID = "fjmobile.editor.Jiaofeilishi"; //$NON-NLS-1$
	...
	public void createPartControl(Composite parent) {
		...
		final TableColumn newColumnTableColumn = new TableColumn(table,
				SWT.NONE);
		newColumnTableColumn.setWidth(8000);
		newColumnTableColumn.setText("缴费");
		...
		button_2.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(final SelectionEvent e) {
				if (!DBFactory.clearAll("jiaofeilishi")) {
		...
		String time = DBFactory.getProp("jiaofeilishi_time");
		...
		actionList.add("jiaofeilishi_retain");
	...
	private void setTime(Label l) {
		...
		DBFactory.Sysprop("jiaofeilishi_time", time);
		l.setText(time);
	}
