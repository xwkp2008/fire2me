...
public class Duanxin extends EditorPart {
	...
	public static final String ID = "fjmobile.editor.Duanxin"; //$NON-NLS-1$
	...
	private void setTime(Label l) {
		...
		DBFactory.Sysprop("duanxin_time", time);
		l.setText(time);
	}
	...
	private int setTable() {
		...
		for (int i = 0; i < col.length; i++) {
			...
			item.setText(new String[] { col[i].getMobileno(),col[i].getDuanxin() });
		}
		return col.length;
	}
