...
public class Yueqianfei extends EditorPart {
	...
	public static final String ID = "fjmobile.editor.Yueqianfei"; //$NON-NLS-1$
	...
	public void createPartControl(Composite parent) {
		...
		final TableColumn newColumnTableColumn = new TableColumn(table,
				SWT.NONE);
		newColumnTableColumn.setWidth(2000);
		newColumnTableColumn.setText("余额欠费");
		...
		button_2.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(final SelectionEvent e) {
				if (!DBFactory.clearAll("yueqianfei")) {
		...
		String time = DBFactory.getProp("yueqianfei_time");
		...
		actionList.add("yueqianfei_retain");
	...
	private void setTime(Label l) {
		...
		DBFactory.Sysprop("yueqianfei_time", time);
		l.setText(time);
	}
